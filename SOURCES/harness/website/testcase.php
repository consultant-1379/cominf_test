...
if ( $mode == "view" )
	echo "<p><a href=" . $_SERVER['PHP_SELF'] . "?mode=edit&tc_id=$tc_id>Edit</a>\n";
if ( $mode == "new" || $mode == "edit" )
	echo "<p><a href=" . $_SERVER['REQUEST_URI'] . ">Discard Edits</a>\n";
if ( $mode != "new" )
	echo "<p><a href=" . $_SERVER['PHP_SELF'] . "?mode=new>Create new</a>\n";
if ( $mode == "edit" ) {
	echo "<p><a href=./testcase_delete.php?tc_id=$tc_id onclick=\" return(OnDeleteClick($tc_id))\">Delete</a>\n";
	echo "<p><a href=" . $_SERVER['PHP_SELF'] . "?mode=new&srctc_id=$tc_id>Copy</a>\n";
}
